...
%     \end{itemize}
  ...
  \begin{frame}{Method comparison: objective, pricing, contract class, interpretability}
    ...
    \toprule
     & \makecell[l]{Chantarat (Baseline)} & \makecell[l]{Chen (NN)} & \makecell[l]{Ours (VMX)} \\
    \midrule
    Objective
...
\begin{frame}{Pricing and Design}
  \begin{itemize}
    ...
    \end{align*}
    \item However, since contracts are designed on zone at a time, portfolio risk isn't observed and a single-zone variant of the premium is used:
    \begin{align*}
